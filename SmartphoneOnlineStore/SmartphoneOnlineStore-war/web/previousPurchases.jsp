...
<html>
    ...
    <body>
        ...
        %> 
        <%
            List<ConcurrentHashMap<Product,Integer>> productsOfPurchases = (List<ConcurrentHashMap<Product,Integer>>)request.getAttribute("purchases");
            if (productsOfPurchases == null){
                ...
                out.println("<table class=\"table table-hover\">");
                    ...
                    out.println("</thead>");
                    out.println("<tbody>");
                for (ConcurrentHashMap<Product,Integer> purchase: productsOfPurchases) {
                    for (Entry<Product,Integer> entry: purchase.entrySet()){ 
